...
type Nested struct {
	...
	RepeatedExternal  []*_struct.Struct          `protobuf:"bytes,17,rep,name=repeated_external,json=repeatedExternal,proto3" json:"repeated_external,omitempty"`
	MapExternal       map[string]*_struct.Struct `protobuf:"bytes,18,rep,name=map_external,json=mapExternal,proto3" json:"map_external,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	GogoField         *_struct.Struct            `protobuf:"bytes,19,opt,name=gogo_field,json=gogoField,proto3" json:"gogo_field,omitempty"`
}
...
func (x *Nested) GetRepeatedExternal() []*_struct.Struct {
	if x != nil {
...
func (x *Nested) GetMapExternal() map[string]*_struct.Struct {
	if x != nil {
...
func (x *Nested) GetGogoField() *_struct.Struct {
	if x != nil {
		return x.GogoField
	}
	return nil
...
var file_tests_api_hello_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x74, 0x53, 0x6b, 0x69, 0x70, 0x70, 0x65, 0x64, 0x22, 0x9f, 0x09, 0x0a, 0x06, 0x4e,
	...
	0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x12, 0x3c, 0x0a, 0x0a, 0x67, 0x6f, 0x67, 0x6f,
	0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x18, 0x13, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53,
	0x74, 0x72, 0x75, 0x63, 0x74, 0x42, 0x04, 0xd0, 0xf5, 0x04, 0x01, 0x52, 0x09, 0x67, 0x6f, 0x67,
	0x6f, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x1a, 0x4e, 0x0a, 0x0c, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61,
...
var file_tests_api_hello_proto_depIdxs = []int32{
	...
	8,  // 13: envoy.type.Nested.gogo_field:type_name -> google.protobuf.Struct
	2,  // 14: envoy.type.NestedEmpty.nested:type_name -> envoy.type.Nested
	1,  // 15: envoy.type.Nested.InitialEntry.value:type_name -> envoy.type.Simple
	8,  // 16: envoy.type.Nested.MapExternalEntry.value:type_name -> google.protobuf.Struct
